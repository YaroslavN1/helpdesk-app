...
test.describe('TicketsPage', () => {
  ...
  test.describe('data rendering', () => {
    // openTicket has no category set, hence shorter name and "—" appearing in both category and assigned-to columns
    ...
    test.describe('filtering', () => {
      ...
      test.describe('status multiselect', () => {
      ...
      test.describe('category multiselect', () => {
